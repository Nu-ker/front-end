...
import { StyleSheet, Text, Modal, FlatList, View, TouchableOpacity, Image, ImageBackground, ActivityIndicator, Alert, Button, AsyncStorage } from 'react-native';
...
export default class listLabel extends Component {
  ...
  setModalVisible(item) {
    ...
    axios.post('https://trackapi.nutritionix.com/v2/natural/nutrients', {
      ...
      .catch(err => {
        Alert.alert('Food is not detected !')
      })
  }
